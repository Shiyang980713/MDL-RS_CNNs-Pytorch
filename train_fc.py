...
from dataset import HSI_LiDAR_Dataset
from model import HSI_FC, MultiModal
...
def build_dataloader(args, split='train'):
    ...
    if split == 'train':
        hsi_path = os.path.join(args.data_path, 'HSI_TrTe/HSI_TrSet.mat')
        lidar_path = os.path.join(args.data_path, 'LiDAR_TrTe/LiDAR_TrSet.mat')
        label_path = os.path.join(args.data_path, 'TrLabel.mat')
    elif split == 'test':
        hsi_path = os.path.join(args.data_path, 'HSI_TrTe/HSI_TeSet.mat')
        lidar_path = os.path.join(args.data_path, 'LiDAR_TrTe/LiDAR_TeSet.mat')
        label_path = os.path.join(args.data_path, 'TeLabel.mat')
    else:
        assert NotImplementedError
    
    logger.info("Building {} dataset from {}...".format(split, args.data_path))
    hsi_lidar_dataset = HSI_LiDAR_Dataset(hsi_path, lidar_path, label_path, split)
